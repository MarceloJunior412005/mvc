...
const Hero = () => {
  return <section id="inicio" className="relative bg-gradient-to-br from-primary to-primary/90 text-primary-foreground py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              <img src="/lovable-uploads/41ee31ee-ad60-4284-bbb5-5b0be31145fe.png" alt="MVC Transportes - Logo" className="h-64 w-64 lg:h-80 lg:w-80 mx-auto object-contain opacity-90" />
            </div>
